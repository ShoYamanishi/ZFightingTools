...
from vcs_to_scs_functions import min_diff_perspective
from vcs_to_scs_functions import min_diff_log_depth_fn
from vcs_to_scs_functions import min_diff_log_depth_cf
...
sampled_min_diff_perspective       = parse_output_from_experiments( FILE_PATH_NORMAL_DEPTH )
sampled_min_diff_log_depth_fn      = parse_output_from_experiments( FILE_PATH_LOG_DEPTH_FN )
sampled_min_diff_log_depth_cf_06   = parse_output_from_experiments( FILE_PATH_LOG_DEPTH_CF_06 )
sampled_min_diff_log_depth_cf_03   = parse_output_from_experiments( FILE_PATH_LOG_DEPTH_CF_03 )
sampled_min_diff_log_depth_cf_00   = parse_output_from_experiments( FILE_PATH_LOG_DEPTH_CF_00 )
...
for far in FARs:
    ...
    min_diff = [ min_diff_perspective( z, NEAR, far ) for z in Z_VCS ]
    min_diff_perspective_list.append( ( Z_VCS_NEG, min_diff ) )
    ...
    min_diff = [ min_diff_log_depth_fn( z, NEAR, far ) for z in Z_VCS ]
    min_diff_log_depth_fn_list.append( ( Z_VCS_NEG, min_diff ) )
    ...
    min_diff = [ min_diff_log_depth_cf( z, 1.0E-06, far ) for z in Z_VCS ]
    min_diff_log_depth_cf_06_list.append( ( Z_VCS_NEG, min_diff ) )
    ...
    min_diff = [ min_diff_log_depth_cf( z, 1.0E-03, far ) for z in Z_VCS ]
    min_diff_log_depth_cf_03_list.append( ( Z_VCS_NEG, min_diff ) )
    ...
    min_diff = [ min_diff_log_depth_cf( z, 1.0, far ) for z in Z_VCS ]
    min_diff_log_depth_cf_00_list.append( ( Z_VCS_NEG, min_diff ) )
...
min_diff_perspective_list_ex = min_diff_perspective_list.copy()
min_diff_perspective_list_ex.append( sampled_min_diff_perspective )

FARLabels_ex = FARLabels.copy()
FARLabels_ex.append( 'far=1.0E10 sampled with test rig' )

plot_single_chart( 
    min_diff_perspective_list_ex,
    FARLabels_ex,
    True, 
    (1.0e-10, None),
   'min diff in VCS', 
   'Min diff in VCS: Perspective Projection, near = 1.0E-1',
   OUTPUT_FILE_PATH + 'plot_min_diff_perspective.png'
)
...
min_diff_log_depth_fn_list_ex = min_diff_log_depth_fn_list.copy()
min_diff_log_depth_fn_list_ex.append( sampled_min_diff_log_depth_fn )

FARLabels_ex = FARLabels.copy()
FARLabels_ex.append( 'far=1.0E10 sampled with test rig' )

plot_single_chart( 
    min_diff_log_depth_fn_list_ex,
    FARLabels_ex,
    True, 
    (1.0e-10, None),
   'min diff in VCS', 
   'Min diff in VCS: Log Depth (ln(-z)-ln(n))/(ln(f)-ln(n)), near = 1.0E-1',
   OUTPUT_FILE_PATH + 'plot_min_diff_log_depth_fn.png'
)
...
min_diff_log_depth_fn_list_ex = min_diff_log_depth_cf_06_list.copy()
min_diff_log_depth_fn_list_ex.append( sampled_min_diff_log_depth_cf_06 )
...
plot_single_chart( 
    ...
    (1.0e-10, None),
   'min diff in VCS', 
   'Min diff in VCS: Log Depth (ln(-cz +1)/ln(cf+1)), C = 1.0E-6',
   OUTPUT_FILE_PATH + 'plot_min_diff_log_depth_cf_06.png'
)
...
min_diff_log_depth_fn_list_ex = min_diff_log_depth_cf_03_list.copy()
min_diff_log_depth_fn_list_ex.append( sampled_min_diff_log_depth_cf_03 )
...
plot_single_chart( 
    ...
    (1.0e-10, None),
   'min diff in VCS', 
   'Min diff in VCS: Log Depth (ln(-cz +1)/ln(cf+1)), C = 1.0E-3',
   OUTPUT_FILE_PATH + 'plot_min_diff_log_depth_cf_03.png'
)
...
min_diff_log_depth_fn_list_ex = min_diff_log_depth_cf_00_list.copy()
min_diff_log_depth_fn_list_ex.append( sampled_min_diff_log_depth_cf_00 )
...
plot_single_chart( 
    ...
    (1.0e-10, None),
   'min diff in VCS', 
   'Min diff in VCS: Log Depth (ln(-cz +1)/ln(cf+1)), C = 1.0',
   OUTPUT_FILE_PATH + 'plot_min_diff_log_depth_cf_00.png'
)

# Comparison among different min_diffs: FAR = 1.0e10
